...
<head>
  ...
  @endphp
  <link rel="icon" href="{{ $getHeaderSetting->getFevicon() }}">
...
<!-- If you want to remove the fixed pages just remove this "fixed sidebar-collapse sidebar-mini" and after sidebar-mini and this "layout-fixed" -->
<body class="hold-transition sidebar-mini fixed sidebar-collapse layout-fixed">
<div class="wrapper">
