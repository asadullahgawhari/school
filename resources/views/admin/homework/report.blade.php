            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-sm-2">
                  ...
                  <input type="text" name="first_name" value="{{ Request::get('first_name') }}" class="form-control" placeholder="Search Student Fist Name">
                </div>
                <div class="form-group col-sm-2">
                  <label>Student Last Name</label>
                  <input type="text" name="last_name" value="{{ Request::get('last_name') }}" class="form-control" placeholder="Search Student Last Name">
                </div>
                <div class="form-group col-sm-2">
                  <label>Class</label>
                ...
                <div class="form-group col-sm-2">
                  ...
                  <a href="{{ url('admin/homework/homework_report') }}" class="btn btn-success" style="margin-top: 32px;"><i class="fas fa-home"></i></a>
                </div>
              </div>
          </form>
        </div>
