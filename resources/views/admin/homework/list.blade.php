      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/homework/homework/add') }}" class="btn btn-primary">Add Homework</a>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-sm-2">
                  ...
                  <a href="{{ url('admin/homework/homework') }}" class="btn btn-success" style="margin-top: 32px;"><i class="fas fa-home"></i></a>
                </div>
              </div>
          </form>
        </div>
