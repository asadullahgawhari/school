      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/assign_class_teacher/add') }}" class="btn btn-primary">Add Assign Class Teacher</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-sm-2">
                  ...
                  <input type="text" name="teacher_name" value="{{ Request::get('teacher_name') }}" class="form-control" placeholder="Search Teacher Name">
                </div>
                <div class="form-group col-sm-2">
                  <label>Status </label>
