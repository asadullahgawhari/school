            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-sm-2">
                  ...
                  <a href="{{ url('admin/attendance/report') }}" class="btn btn-success" style="margin-top: 32px;"><i class="fas fa-home"></i></a>
                </div>
              </div>
          </form>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <form style="float: right;" method="post" action="{{ url('admin/attendance/export_Attendance_report') }}">
                {{ csrf_field() }}
                ...
                <input type="hidden" value="{{ Request::get('class_name') }}" name="class_name">
