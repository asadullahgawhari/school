          ...
          <form method="get" action="">
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-sm-3">
                  <label>Note</label>
                  <input type="text" name="note" value="{{ Request::get('note') }}" class="form-control" placeholder="Search Note">
                </div>
                <div class="form-group col-sm-3">
                  <label>Date</label>
                ...
                <div class="form-group col-sm-3">
                  ...
                  <a href="{{ url('admin/examinations/exam/list') }}" class="btn btn-success" style="margin-top: 32px;"><i class="fas fa-home"></i></a>
                </div>
              </div>
          </form>
        </div>
                    ...
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td style="min-width: 120px;">
                          <a href="{{ url('admin/examinations/exam/edit/'.$value->id ) }}" class="btn btn-primary btn-sm fas fa-edit"></a>
                          <a href="{{ url('admin/examinations/exam/delete/'.$value->id ) }}" class=" btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
