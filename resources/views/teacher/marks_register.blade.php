                    ...
                    <form method="post" class="SubmitForm">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-primary" style="margin-top: 5px;" target="_blank" href="{{ url('teacher/my_exam_result/print?exam_id='.Request::get('exam_id').'&student_id='.$student->id) }}">Print</a>
