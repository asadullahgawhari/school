            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-sm-2">
                  ...
                  <a href="{{ url('parent/my_student/submitted_homework/'.$getStudent->id) }}" class="btn btn-success" style="margin-top: 32px;"><i class="fas fa-home"></i></a>
                </div>
              </div>
          </form>
        </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Student Submitted Homework - {{ $getStudent->name }} {{ $getStudent->last_name }}</h3>
              </div>
