...
class ClassSubjectController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $data['header_title'] = "Add New Class Assign Subject";
    ...
    public function insert(Request $request)
    {
        if (!empty($request->subject_id)) {
            ...
            {
                // this varible for remove the duplicate subject id 
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/assign_subject/list')->with('success', "Class assign subject successfully updated");
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with('danger', "Class assign subject successfully deleted");
    }
}
