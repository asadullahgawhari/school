...
class ExaminationsController extends Controller
{
    ...
    public function exam_delete($id)
    {
        ...
        return redirect('admin/examinations/exam/list')->with('danger', "Admin successfully deleted");
    }
    ...
    public function submit_marks_register(Request $request)
    {
        ...
        if (!empty($request->mark)) 
        {
            foreach($request->mark as $mark)  
            {
                ...
                {
                    $getMark = MarksRegisterModel::checkAllreadyMark($request->student_id, $request->exam_id, $request->class_id, $mark['subject_id']);
        ...
        {
            $json['message'] = "Marks Register successfully saved. some subject mark greather than total mark ";
        }
    ...
    public function myExamResult()
    {
        ...
        $data['header_title'] = "My Exam Timetabel";
    ...
    // Single Submit Marks Register For Save
    public function single_submit_marks_register(Request $request)
    {
        ...
        if ($full_marks >= $total_mark) 
        {
            $getMark = MarksRegisterModel::checkAllreadyMark($request->student_id, $request->exam_id, $request->class_id, $request->subject_id);
    ...
    // Student side - student exam timetable
    ...
    // Teacher side - Teacher's student side
    ...
    // Parent side - Parent's son exam timetable
    public function MyExamTimetableParent($student_id)
    {
        ...
        $data['header_title'] = "Exam Timetabel";
        return view('parent/my_exam_timetable', $data);
    }

    // Parent side - Parent's son exam Result
    ...
    public function marks_grade_add(Request $request)
    {
    ...
    public function marks_grade_delete($id)
    {
        ...
        return redirect()->back()->with('danger', "Marks Grade successfully deleted");
    }
}
