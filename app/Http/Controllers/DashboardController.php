    ...
    public function dashboard()
    {
        ...
        else if (Auth::user()->user_type == 4) 
        {
            ...
            if (!empty($student_ids)) 
            {
                ...
                $data['TotalAttendance'] = StudentAttendanceModel::getStudentParentCount($student_ids);
            }
            else
            {
            ...
            $data['TotalNoticeBorard'] = NoticeBoardModel::getRecordUserCount(Auth::user()->user_type);
