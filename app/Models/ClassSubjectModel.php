...
class ClassSubjectModel extends Model
{
    ...
    {
        $return = self::select('class_subject.*', 'users.name as created_by_name', 'class.name as class_name', 'subject.name as subject_name')
            ...
            if (!empty(Request::get('status'))) {
                ...
                $return = $return->where('class_subject.status', '=', $status);
            }
