...
class AssignClassTeacherModel extends Model
{
    ...
    {
        return self::select('assign_class_teacher.*', 'users.name as created_by_name', 'class.name as class_name', 'subject.name as subject_name', 'subject.type as subject_type', 'class.id as class_id', 'subject.id as subject_id')
            ->join('class', 'class.id', 'assign_class_teacher.class_id')
            ->join('class_subject', 'class_subject.class_id', 'class.id')
            ->join('users', 'users.id', 'assign_class_teacher.created_by')
            ->join('subject', 'subject.id', '=', 'class_subject.subject_id')
    ...
    // Teacher side - Teacher's student exam timetable
    ...
    // Teacher side - Teacher's Calendar 
    ...
    // Teacher side - Timetable teacher
