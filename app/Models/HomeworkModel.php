...
class HomeworkModel extends Model
{
    ...
    static public function getRecord()
    {
        $return = self::select('homework.*', 'class.name as class_name', 'subject.name as subject_name', 'users.name as created_by_name')
            ...
            {
                $return = $return->where('homework.created_at', '>=', Request::get('from_created_at'));        
            }
            if (!empty(Request::get('to_created_at'))) 
            {
                $return = $return->where('homework.created_at', '<=', Request::get('to_created_at'));        
            }
